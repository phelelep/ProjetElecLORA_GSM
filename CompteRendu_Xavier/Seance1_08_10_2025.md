...
Le projet consiste à rendre **connectée des ruches**. Les ruches envoient leurs mesures au module LoRa de la gateway, capable de collecter et transmettre des données à distance via GSM, soit SMS Téléphone.  
...
L’ensemble du circuit sera alimenté par une **batterie 3V3 provenant d'un projet externe**.
